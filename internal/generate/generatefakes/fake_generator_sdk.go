...
type FakeGeneratorSDK struct {
	GeneratePackageManifestStub        func(string, string, string, ...*generate.PkgOptions) error
...
func (fake *FakeGeneratorSDK) GeneratePackageManifest(arg1 string, arg2 string, arg3 string, arg4 ...*generate.PkgOptions) error {
...
func (fake *FakeGeneratorSDK) GeneratePackageManifestCalls(stub func(string, string, string, ...*generate.PkgOptions) error) {
	fake.generatePackageManifestMutex.Lock()
	defer fake.generatePackageManifestMutex.Unlock()
	fake.GeneratePackageManifestStub = stub
}

func (fake *FakeGeneratorSDK) GeneratePackageManifestArgsForCall(i int) (string, string, string, []*generate.PkgOptions) {
	fake.generatePackageManifestMutex.RLock()
	defer fake.generatePackageManifestMutex.RUnlock()

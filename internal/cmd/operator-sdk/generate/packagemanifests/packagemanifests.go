...
func (c packagemanifestsCmd) generatePackageManifest() error {
	...
	writer, err := os.OpenFile(filepath.Join(c.outputDir, c.projectName+".package.yaml"), os.O_RDWR|os.O_CREATE, 0666)
	if err != nil {
		return err
	}
	...
	if err := c.generator.GeneratePackageManifest(c.projectName, c.version, writer, opts); err != nil {
		return err
	}
	return nil
}
